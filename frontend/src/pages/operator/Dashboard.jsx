...
// 💡 Ganti dengan data user yang didapat setelah login.
const DUMMY_USER = { id: 13, name: "User A" }; 
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 justify-items-center">
          {furnaceList.map((furnace, index) => {
            ...
            const isLockedByMe = status?.is_active && status?.active_userID === DUMMY_USER.id;
            const isLockedByOther = status?.is_active && status?.active_userID !== DUMMY_USER.id;
            ...
            return (
              ...
              >
                ...
                {/* --- Kontrol Setpoint (Selalu Terlihat) --- */}
                <div className="mt-4">
