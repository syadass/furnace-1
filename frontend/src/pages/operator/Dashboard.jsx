...
const Dashboard = () => {
    ...
    // --- PERBAIKAN DI SINI ---
    // useEffect ini sekarang hanya berjalan sekali saat komponen dimuat,
    // tidak lagi setiap kali jendela browser mendapat fokus.
    useEffect(() => {
    ...
    const handleStartSession = async (furnace) => {
        try {
            ...
            fetchFurnaceStatuses(); // Refresh status setelah aksi
        } catch (err) {
