...
exports.startSession = (req, res) => {
    ...
    db.query(checkQuery, [furnace_id], (err, results) => {
        ...
        db.beginTransaction(err => {
            ...
            // 2. Catat sesi baru ke session_history
            ...
            db.query(sessionQuery, [furnace_id, userID], (err, sessionResult) => {
                ...
                // 3. Update status furnace seperti biasa
                const updateQuery = `
...
exports.endSession = (req, res) => {
    ...
    db.query(checkQuery, [furnace_id, userID], (err, results) => {
        ...
        db.beginTransaction(err => {
            ...
            // 1. Update endTime di session_history untuk sesi yang sedang berjalan
            ...
            db.query(sessionQuery, [furnace_id, userID], (err, sessionResult) => {
                ...
                // 2. Update status furnace seperti biasa
                const updateQuery = `
            UPDATE furnace_status 
